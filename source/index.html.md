...
email | object | False | The **email** object associated to unqualified lead
...
email | A **JSON** [email object](#email-properties)
phone | A **JSON** [phone object](#phones).
unqualified_lead_opt_in | A **JSON** [unqualified_lead_opt_in object](#unqualified-lead-opt-in-properties)
contact_type_id | integer | False | The **contact_type_id** relative to unqualified lead
